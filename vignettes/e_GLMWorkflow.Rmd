...
```{r environmental background sampling, warning=FALSE, eval = FALSE}
...
```
```{r environmental background sampling hidden, warning=FALSE, echo=FALSE}
backgroundSamplingRegions <- vect(system.file("extdata/backgroundSamplingRegions.shp",
                              package='voluModel'))
```

```{r plot study region plot, echo=FALSE, out.width = '100%', out.height= '100%'}
...
INVEMAR. SIBM en línea: Sistema de Información sobre Biodiversidad Marina. Santa Marta: Instituto de investigaciones Marinas y Costeras José Benito Vives de Andréis,. https://www.invemar.org.co/siam/sibm/index.htm Accessed via OBIS on 2020-11-04. 
