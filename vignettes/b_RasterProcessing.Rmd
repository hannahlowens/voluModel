...
oxygen <- vect(paste0(td, "/oxygen/woa18_all_A00mn01_cropped.shp"))[,1:70] # Only taking uppermost 70 depth layers, for speed
...
p4 <- oneRasterPlot(oxygenSmooth[[1]], land = land, landCol = "black",
     title = "Bottom Apparent Oxygen Utilization\n(µmol/kg), interpolated and smoothed")
```
