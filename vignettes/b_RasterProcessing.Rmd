...
knitr::opts_chunk$set(echo = TRUE, error = TRUE, fig.retina = 1, dpi = 96)
...
p1 <- oneRasterPlot(oxygenBottom,land = land, landCol = "black", 
...
p2 <- oneRasterPlot(oxygenBottomInterpolated, land = land, landCol = "black", 
              title = "Apparent oxygen utilization, bottom")

temp <- c("Raw" = p1, "Interpolated" = p2)
update(temp, strip  = strip.custom(strip.levels = TRUE,
                             horizontal = TRUE,
                             bg = "black",
                             fg = "white",
...
p1 <- oneRasterPlot(oxygen[[1]], land = land, landCol = "black", 
              title= "Apparent Oxygen Utilization, interpolated")
