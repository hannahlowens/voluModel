...
```{r alpha hull demonstration, message=FALSE, warning=FALSE, eval=FALSE}
...
```{r plot alpha hull demonstration, echo=FALSE}
...
```{r basic marineBackground demonstration, message=FALSE, warning=FALSE, eval=FALSE}
trainingRegion <- marineBackground(occurrences,
...
```{r plot basic marineBackground demonstration, echo=FALSE}
...
```{r clipToOcean demo, message=FALSE, warning=FALSE, eval=F}
trainingRegion <- marineBackground(occurrences, 
...
```{r plot clipToOcean demo, echo=FALSE}
trainingRegion <- marineBackground(occurrences, 
                                fraction = .95, partCount = 2, buff = 1000000, 
                                clipToOcean = T)
...
```{r meridian wrap demo, warning=FALSE, message=FALSE, eval=F}
...
```{r plot meridian wrap demo, echo=FALSE}
