...
knitr::opts_chunk$set(echo = TRUE, error = FALSE, fig.retina = 1, dpi = 96)
...
For a more complex, multivariate example of environmental dissimilarity weighting, refer to the [GLM workflow](GLMWorkflow.html).
