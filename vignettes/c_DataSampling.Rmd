...
```{r occurrence dataset plotting code, message=FALSE, warning = FALSE, eval=TRUE, echo = FALSE}
# Map occurrences
...
INVEMAR (2022). SIBM en línea: Sistema de Información sobre Biodiversidad Marina. Santa Marta: Instituto de investigaciones Marinas y Costeras José Benito Vives de Andréis,. https://www.invemar.org.co/siam/sibm/index.htm Accessed via OBIS on 2020-11-04. 
