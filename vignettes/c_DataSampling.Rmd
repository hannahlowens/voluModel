...
land <- rnaturalearth::ne_countries(scale = "small", returnclass = "sf")[1]
knitr::include_graphics(system.file("extdata/pointMap.png", 
                                    package = "voluModel"), 
...
```{r plot alpha hull demonstration, echo=FALSE, fig.width=7}
...
This chunk of code loads the example data shapefile, which results in a `SpatialPointsDataFrame`:
