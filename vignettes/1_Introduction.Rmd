...
Here is how the occurrence data file is structured, and where the occurrences we will be using are located.

```{r show points, warning=FALSE, echo=FALSE, message=FALSE}
head(occurrences)
...
Here you see plots at the sea surface and the bottom. The AOU dataset has been interpolated and smoothed using a thin plate spline algorithm. For more details on how to process environmental data, see [the raster data tutorial](2_RasterProcessing.html). 

```{r environmental data plotting, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r data extraction, echo=FALSE, warning=FALSE}
# Extract temperature
...
```{r temperature violin plots, echo=FALSE}
# Collation
...
```{r oxygen violin plots, echo=FALSE}
# Collation
